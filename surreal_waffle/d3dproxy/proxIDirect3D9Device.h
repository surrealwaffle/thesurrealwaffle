#ifndef PROXIDIRECT3D9DEVICE_H
#define PROXIDIRECT3D9DEVICE_H

#include "stdafx.h"

/*
 looked at necessary functions to replicate and went nope
 code here and in the .cpp is taken from another proxy dll tutorial, and modified to my style and necessary functionality
*/

class proxIDirect3DDevice9 : public IDirect3DDevice9
{
private:
    IDirect3DDevice9 *const lpIDirect3DDevice9;
public:
	proxIDirect3DDevice9(IDirect3DDevice9 *const pOriginal) : lpIDirect3DDevice9( pOriginal ) { }
	proxIDirect3DDevice9( void ) : lpIDirect3DDevice9( NULL ) { }
	virtual ~proxIDirect3DDevice9(void) { }
